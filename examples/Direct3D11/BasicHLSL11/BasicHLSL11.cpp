                                      ...
                                      void* pUserContext )
{
    ...
    switch( DXUTGetD3D11DeviceFeatureLevel() )
    {
        case D3D_FEATURE_LEVEL_11_0:
           {
            V_RETURN( CompileShaderFromFile( L"BasicHLSL11_VS.hlsl", "VSMain", "vs_5_0", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"BasicHLSL11_PS.hlsl", "PSMain", "ps_5_0", &pPixelShaderBuffer ) );
            break;
           }
        case D3D_FEATURE_LEVEL_10_1:
           {
            V_RETURN( CompileShaderFromFile( L"BasicHLSL11_VS.hlsl", "VSMain", "vs_4_1", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"BasicHLSL11_PS.hlsl", "PSMain", "ps_4_1", &pPixelShaderBuffer ) );
            break;
           }
        ...
        case D3D_FEATURE_LEVEL_9_3:
           {
            V_RETURN( CompileShaderFromFile( L"BasicHLSL11_VS.hlsl", "VSMain", "vs_4_0_level_9_3", &pVertexShaderBuffer ) );
            V_RETURN( CompileShaderFromFile( L"BasicHLSL11_PS.hlsl", "PSMain", "ps_4_0_level_9_3", &pPixelShaderBuffer ) );
            break;
           }
