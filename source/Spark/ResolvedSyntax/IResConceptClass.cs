...
namespace Spark.ResolvedSyntax
{
    ...
    public class ResConceptVal : ResExp
    {
        public ResConceptVal(
            SourceRange range,
            IResConceptClassRef conceptClass,
            IEnumerable<IResMemberRef> memberRefs)
            : base(range, conceptClass)
        {
            _conceptClass = conceptClass;
        ...
        public IEnumerable<IResMemberRef> MemberRefs { get { return _memberRefs; } }

        private IResConceptClassRef _conceptClass;
        private IResMemberRef[] _memberRefs;
    }
}
