...
{
    public class ResSimpleType : IResTypeExp
    {
        public ResSimpleType()
        { }
    ...
    public class ResBottomType : ResSimpleType
    {
    ...
    public class ResTopType : ResSimpleType
    {
        public override string ToString()
        {
            return "Top";
    ...
    public class ResVoidType : ResSimpleType
    {
        public override string ToString()
        {
            return "Void";
