...
namespace Spark.Mid
{
    public class MidAttributeFetch : MidPath
    {
        ...
        {
            return string.Format("{0}.{1}", _obj, _attribute.Value.Name);
        }
        ...
        public MidAttributeDecl Attribute { get { return _attribute.Value; } }

        private MidPath _obj;
        private ILazy<MidType> _type;
        private ILazy<MidAttributeDecl> _attribute;
    }
}
